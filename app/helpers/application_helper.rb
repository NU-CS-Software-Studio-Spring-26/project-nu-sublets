...
module ApplicationHelper
  NAV_ITEM_ICONS = {
    ...
    community_guidelines: '<svg class="nav-item-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" aria-hidden="true" focusable="false"><path fill="currentColor" d="M8 0 2 2.6v4.7c0 3.8 2.55 7.03 6 8.7 3.45-1.67 6-4.9 6-8.7V2.6zm3.47 5.72-4.1 4.1a.75.75 0 0 1-1.06 0L4.53 8.03a.75.75 0 0 1 1.06-1.06l1.25 1.25 3.57-3.56a.75.75 0 0 1 1.06 1.06"/></svg>'.html_safe,
