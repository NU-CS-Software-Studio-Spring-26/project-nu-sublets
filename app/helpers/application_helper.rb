...
module ApplicationHelper
  ...
  NAV_ITEM_ICONS = {
    ...
    chat: '<svg class="nav-item-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" aria-hidden="true" focusable="false"><path fill="currentColor" d="M2 1h11a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1h-3l-3 2.5v-2.5H2a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1z"/></svg>'.html_safe,
    profile: '<svg class="nav-item-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" aria-hidden="true" focusable="false"><path fill="currentColor" d="M8 7a2 2 0 1 0 0-4 2 2 0 0 0 0 4zm3 2H5a2 2 0 0 0-2 2v2h10v-2a2 2 0 0 0-2-2z"/></svg>'.html_safe,
    about_us: '<svg class="nav-item-icon footer-nav-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.45" aria-hidden="true" focusable="false"><circle cx="8" cy="8" r="6.15"/><path d="M8 7.25v3.6M8 5.15h.01"/></svg>'.html_safe,
    community_guidelines: '<svg class="nav-item-icon footer-nav-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.45" aria-hidden="true" focusable="false"><path d="M5.35 2.25h5.3M6 1.4h4a1 1 0 0 1 1 1v.85H5V2.4a1 1 0 0 1 1-1"/><path d="M4.25 2.9H3.6a1.5 1.5 0 0 0-1.5 1.5v8.1A1.5 1.5 0 0 0 3.6 14h8.8a1.5 1.5 0 0 0 1.5-1.5V4.4a1.5 1.5 0 0 0-1.5-1.5h-.65M5 8.1l1.45 1.45L10.8 5.7"/></svg>'.html_safe,
    privacy_policy: '<svg class="nav-item-icon footer-nav-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.45" aria-hidden="true" focusable="false"><rect x="3.15" y="7" width="9.7" height="6.9" rx="1.55"/><path d="M5.35 7V5.05a2.65 2.65 0 0 1 5.3 0V7"/></svg>'.html_safe,
    disclaimer: '<svg class="nav-item-icon footer-nav-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.45" aria-hidden="true" focusable="false"><path d="M7.05 2.45a1.1 1.1 0 0 1 1.9 0l5.45 9.45a1.1 1.1 0 0 1-.95 1.65H2.55a1.1 1.1 0 0 1-.95-1.65z"/><path d="M8 6.15v3M8 11.55h.01"/></svg>'.html_safe,
    github: '<svg class="nav-item-icon footer-nav-icon footer-nav-icon--github" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true" focusable="false"><g transform="translate(1.25 1.25) scale(0.84375)"><path d="M8 0C3.58 0 0 3.58 0 8a8.01 8.01 0 0 0 5.47 7.59c.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49C4 14.09 3.48 13.2 3.32 12.74c-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.5-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82a7.54 7.54 0 0 1 4 0c1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.01 8.01 0 0 0 16 8c0-4.42-3.58-8-8-8"/></g></svg>'.html_safe
  }.freeze
