...
ActiveRecord::Schema[8.1].define(version: 2026_06_07_130000) do
  ...
  create_table "conversations", force: :cascade do |t|
    ...
    t.datetime "last_read_at_initiator"
    t.datetime "last_read_at_recipient"
    t.integer "recipient_id", null: false
    t.integer "sublet_listing_id"
    t.datetime "updated_at", null: false
    t.index ["conversation_key"], name: "index_conversations_on_conversation_key", unique: true
    t.index ["initiator_id", "recipient_id"], name: "index_conversations_on_initiator_id_and_recipient_id"
    t.index ["initiator_id"], name: "index_conversations_on_initiator_id"
    t.index ["recipient_id", "initiator_id"], name: "index_conversations_on_recipient_id_and_initiator_id"
    t.index ["recipient_id"], name: "index_conversations_on_recipient_id"
    t.index ["sublet_listing_id"], name: "index_conversations_on_sublet_listing_id"
  end
  ...
  add_foreign_key "conversations", "sublet_listings"
