...
class PagesFlowTest < ActionDispatch::IntegrationTest
  ...
  test "posted listing photos are visible to other signed in students" do
    ...
    assert_response :success
    assert_select ".gallery-photo[src*='/rails/active_storage/']", count: 1
    assert_select "[data-photo-carousel-source][data-src*='/rails/active_storage/']", count: 1
  ...
  test "home browse cards use database listing owners and stored profile photos" do
    ...
    listing.photos.attach(uploaded_test_file("home-card.jpg", "image/jpeg", "home card photo"))
